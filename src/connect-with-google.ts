...
module.exports = (req: any, res: any) => {
	...
	const scopes = encodeURIComponent("https://www.googleapis.com/auth/ndev.clouddns.readwrite");
   ...
   `.replace(/(\r\n|\n|\r)/gm, "");
	...
	res.writeHead(302, {
		...
		'Set-Cookie': cookie.serialize('now-externaldns-context', JSON.stringify(context), { path: '/' })
	});
	res.end('Redirecting...');
}